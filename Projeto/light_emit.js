...
(function(){
  ...
  function setupScene(){
    ...
    var texture = new THREE.TextureLoader().load( 'textura_final.png' );
    geometry = new THREE.BoxBufferGeometry( 1, 1, 1 );
    material = new THREE.MeshLambertMaterial( { map: texture, opacity: 1, transparent: true, side: THREE.DoubleSide });
